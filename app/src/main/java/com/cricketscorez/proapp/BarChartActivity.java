...
public class BarChartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BarChartView chartView = findViewById(R.id.customBarChart);

        // ডাটা রিসিভ (MainActivity থেকে পাঠানো Key অনুযায়ী)
        ...
        // কাস্টম ভিউতে ডাটা সেট করা
        chartView.setData(inn1Runs, inn1Wkts, inn2Runs, inn2Wkts, t1, t2, totalOvers);
    }
}
