...
public class WormGraphActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_worm_graph);

        WormGraphView wormView = findViewById(R.id.customWormGraph);
        ...
        wormView.setData(inn1Runs, inn1Wkts, inn2Runs, inn2Wkts, t1, t2, totalOvers);
    }
}
